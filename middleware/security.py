...
class InputValidationMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next):
        try:
            ...
            # - Gemini AI endpoints: accept natural language that may contain technical terms, code, SQL, etc.
            BODY_VALIDATION_WHITELIST = [
                ...
                "/api/v1/gemini/chat",  # Gemini chat accepts any natural language input
                "/api/v1/gemini/generate-flowchart",  # Flowchart descriptions can contain technical terms
                "/api/v1/gemini/analyze-script",  # Script analysis may reference code/technical concepts
            ]
