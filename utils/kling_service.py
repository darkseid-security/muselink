...
def get_kling_service_for_user(user_id: int) -> KlingVideoService:
    """
    Get KlingVideoService instance for a specific user (reads API key from database)

    Args:
        user_id: User's ID

    Returns:
        KlingVideoService instance configured with user's API key
    ...
    try:
        ...
        return KlingVideoService(api_key)
