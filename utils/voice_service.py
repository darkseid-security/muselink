...
def get_voice_service_for_user(user_id: int) -> VoiceGenerationService:
    """
    Get VoiceGenerationService instance for a specific user (reads API key from database)

    Args:
        user_id: User's ID

    Returns:
        VoiceGenerationService instance configured with user's API key
    ...
    try:
        ...
        return VoiceGenerationService(api_key)
