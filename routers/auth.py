...
async def register(user_data: UserRegister, request: Request, captcha_hash: str = None):
    """
    ...
    try:
        ...
        try:
            ...
            logger.info(f"New user registered: {username} - verification email sent to {email}")
        except Exception as e:
